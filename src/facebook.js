...
class FacebookLogin extends React.Component {
  ...
  click = () => {
    ...
    if (navigator.userAgent.match('CriOS')) {
      window.location.href = `https://www.facebook.com/dialog/oauth?client_id=${appId}&redirect_uri=${window.location.href}&state=facebookdirect&auth_type=${auth_type}&${scope}`;
    } else {
